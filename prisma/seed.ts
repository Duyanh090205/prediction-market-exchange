...
const SEED_USERS: SeedUser[] = [
  {
    username: "sam",
    email: process.env.SAM_EMAIL ?? "sam@example.com",
  ...
  {
    username: "ivan",
    email: process.env.IVAN_EMAIL ?? "ivan@example.com",
    role: Role.USER,
    balance: 1000,
  },
  {
    username: "james",
    email: process.env.JAMES_EMAIL ?? "james@example.com",
    role: Role.USER,
    balance: 1000,
  },
  {
    username: "thy",
    email: process.env.THY_EMAIL ?? "thy@example.com",
    role: Role.USER,
    balance: 1000,
  },
  {
    username: "khang",
    email: process.env.KHANG_EMAIL ?? "khang@example.com",
    role: Role.USER,
    balance: 1000,
  },
  {
    username: "hieu",
    email: process.env.HIEU_EMAIL ?? "hieu@example.com",
    role: Role.USER,
    balance: 1000,
  },
];
